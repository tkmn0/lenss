...
func (i *IVFWriter) writeHeader() error {
	...
	binary.LittleEndian.PutUint16(header[12:], 1920) // Width in pixels
	binary.LittleEndian.PutUint16(header[14:], 1080) // Height in pixels
...
// WriteData writes bytes the appropriate headers for it
func (i *IVFWriter) WriteData(data []byte) error {
	if i.ioWriter == nil {
		return errFileNotOpened
	}

	i.seenKeyFrame = true
	i.currentFrame = append(i.currentFrame, data[0:]...)
